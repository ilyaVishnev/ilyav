...
import ru.job4j.threads.SaveDynamicLinkedList;
...
public class SaveDynamicLinkedListTest {

    SaveDynamicLinkedList<Integer> saveDynamicLinkedList = new SaveDynamicLinkedList<>();
    ...
    public void whenAddToListIsSaveThread() throws InterruptedException {
        ...
        Iterator<Integer> iterator = saveDynamicLinkedList.iterator();
    ...
    public class AddThread extends Thread {
        ...
        @Override
        public void run() {
            saveDynamicLinkedList.add(i * 3 + 2);
        }
    }
    ...
    public class GetThread extends Thread {
        ...
        @Override
        public void run() {
            list.add(saveDynamicLinkedList.get(i));
        }
    }
}
